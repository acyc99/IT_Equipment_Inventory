...
const { User, IT_Equip_WO, Laptop, Monitor, Docking_Station, Adaptor, Mouse, Keyboard, Lock, Other_Equipment, Cell_Phone_WO, Cell_Phone} = require('./it-equipment')(sequelize, Sequelize.DataTypes);
db.models.User = User;
